      ...
      <Drawer>
        ...
        <div className="absolute -top-6 left-0 right-0 flex justify-center px-4">
          <DrawerTrigger asChild>
            <button className="bg-brand-red hover:bg-brand-red-hover text-white w-full max-w-md py-3 rounded-full shadow-lg flex items-center justify-center gap-2 border-2 border-white active:scale-95 transition-transform animate-pulse cursor-pointer">
